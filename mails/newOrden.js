...
const newOrden = async (emails, order) => {
    const config = {
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="padding: 8%; font-family: Roboto, Helvetica, Arial, sans-serif">
                                                ...
                                                <p>Se ha recibido una nueva orden de compra N°<strong>${order.id.substr(0, 8).toUpperCase()}</strong></p>
                                                <p>Por un monto de ${order.total}</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
