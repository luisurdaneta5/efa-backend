...
const exchangeAccept = async (email, exchange) => {
    const config = {
    ...
    let info = await transporter.sendMail({
        ...
        subject: "Su recarga de saldo ha sido aprobada!!", // Subject line
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="padding: 8%; font-family: Roboto, Helvetica, Arial, sans-serif">
                                                ...
                                                <p>Su recarga de saldo N°<strong>${exchange.substr(0, 8).toUpperCase()}</strong> ha sido aprobada.</p>
                                                <p>Ya podra disfrutar de su nuevo saldo y realizar compras mediante nuestra tienda Online</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
