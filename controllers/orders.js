...
const orderCompleteMail = require("../mails/orderCompleteMail");
const Email = require("../models/email");
const newOrden = require("../mails/newOrden");
...
const createOrder = async (req, res = response) => {
    ...
    try {
        ...
        if (balance.amount == 0) {
            ...
            if (emails) {
                newOrden(emails, order);
            }

            orderCompleteMail(body.email, order);
    ...
    try {
        if (!body.uid) {
            ...
            const order = await Order.findOne({
                ...
                attributes: {
                    exclude: ["id", "email", "userId", "note", "updatedAt"],
                },
            });
